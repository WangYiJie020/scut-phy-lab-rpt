...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{exp1-弗朗克/弗兰克赫兹实验仪器.jpg}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[c]{0.27\linewidth}
        \centering
				\includegraphics[width=\linewidth]{../exp1-弗朗克/实验装置图.png}
        \caption{实验原理示意图}\label{fig:show1}
    \end{minipage}
    \hspace{1em} % 添加一点水平间距，防止图片紧贴
    \begin{minipage}[c]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{exp1-弗朗克/I_A-U_G2K曲线.png}
...
\begin{minipage}[t]{0.35\linewidth} % 右侧图片部分，占 30% 宽度
    ...
    \centering
    \includegraphics[width=\linewidth]{exp1-弗朗克/弗兰克实验连接图.png}
\end{minipage}

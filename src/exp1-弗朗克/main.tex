...
\]
取氩原子第一激发电位公认值 $U_{0\text{ref}} = 11.55\ \text{V}$，则峰值法与谷值法的相对误差分别为
\[
  \eta_{\text{峰}} = \frac{|11.76 - 11.55|}{11.55} \times 100\% = 1.82\%
\]
\[
  \eta_{\text{谷}} = \frac{|11.80 - 11.55|}{11.55} \times 100\% = 2.16\%
\]
综合峰、谷两组结果，可认为本实验测得氩原子的第一激发电位与公认值较为接近。
...
采用逐差法处理数据后，峰值法得到的第一激发电位为 $11.76\ \text{V}$，谷值法得到的第一激发电位为 $11.80\ \text{V}$，两者与公认值 $11.55\ \text{V}$ 都较为接近，相对误差分别为 $1.82\%$ 和 $2.16\%$。这说明本次实验测量结果可信，实验装置工作正常，所测曲线能够较好反映氩原子第一激发电位的物理意义。
